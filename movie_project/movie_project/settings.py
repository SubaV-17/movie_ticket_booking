...
SECRET_KEY = 'django-insecure-)1j#57sa1tr$cfv+$ii4@57o^ys_2eb4v(0eq0(+75@k0c$+mu'
...
# Optional - helpful for development
STATICFILES_DIRS = ["/booking/static/",]  # For custom static directory
